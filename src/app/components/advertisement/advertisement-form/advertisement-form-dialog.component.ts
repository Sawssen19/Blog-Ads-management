          ...
          <form [formGroup]="basicInfoForm" class="form-step">
            ...
            <div class="form-row">
              <mat-form-field appearance="outline" class="half-width">
                ...
                <mat-error
                  *ngIf="basicInfoForm.get('type')?.hasError('required')"
                >
                  Le type est requis
                </mat-error>
              </mat-form-field>
          ...
          <form [formGroup]="schedulingForm" class="form-step">
            ...
            <div class="form-row">
              <mat-form-field appearance="outline" class="half-width">
                ...
                <mat-error
                  *ngIf="schedulingForm.get('startDate')?.hasError('required')"
                >
              ...
              <mat-form-field appearance="outline" class="half-width">
                ...
                <input
                  ...
                  [min]="schedulingForm.get('startDate')?.value"
                />
                <mat-datepicker-toggle
                  matIconSuffix
                  [for]="endPicker"
                ...
                <mat-error
                  *ngIf="schedulingForm.get('endDate')?.hasError('required')"
                >
          ...
          <div class="confirmation-step">
            ...
            <div class="summary-card">
              <div class="summary-section">
                ...
                <p>
                  <strong>Type:</strong>
                  {{ getTypeLabel(basicInfoForm.get('type')?.value) }}
                </p>
                <p>
                  <strong>Position:</strong>
                  {{ getPositionLabel(basicInfoForm.get('position')?.value) }}
                </p>
              </div>
              ...
              <div class="summary-section">
                ...
                <p>
                  <strong>Début:</strong>
                  {{ formatDate(schedulingForm.get('startDate')?.value) }}
                </p>
                <p>
                  <strong>Fin:</strong>
                  {{ formatDate(schedulingForm.get('endDate')?.value) }}
                </p>
                <p>
                  <strong>Localisation:</strong>
                  {{ schedulingForm.get('location')?.value || 'Non spécifié' }}
                </p>
              </div>

              <div class="summary-section">
                <h4>Public cible</h4>
                <div class="audience-chips"></div>
              </div>
            </div>
...
export class AdvertisementFormDialogComponent implements OnInit {
  ...
  constructor(
    ...
    this.basicInfoForm = this.fb.group({
      ...
      position: [
        data?.advertisement?.position || 'header',
        Validators.required,
      ],
    });
    ...
    this.schedulingForm = this.fb.group(
      {
        startDate: [
          data?.advertisement?.startDate || today,
          Validators.required,
        ],
        endDate: [
          data?.advertisement?.endDate || thirtyDaysFromNow,
          Validators.required,
        ],
      },
    ...
    this.schedulingForm
      ...
      ?.valueChanges.subscribe((startDate) => {
        ...
        if (
          ...
          endDateControl.value < startDate
        ) {
