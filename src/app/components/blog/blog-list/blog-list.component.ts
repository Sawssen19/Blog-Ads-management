    ...
    <div class="blog-container">
      ...
      <div class="main-content">
        <div class="content-header">
          <h2>
            {{
              activeTabIndex === 0 ? 'Tous les articles' : 'Articles favoris'
            }}
          </h2>
        ...
        <div class="blog-grid" [class.list-view]="currentView === 'list'">
          <mat-card
            *ngFor="
              let blog of activeTabIndex === 0 ? filteredBlogs : favoriteBlogs
            "
            class="blog-card"
          >
            <div
            ...
            >
              <img
                [src]="blog.imageUrl || 'assets/images/default-blog.jpg'"
                [alt]="blog.title"
            ...
            <mat-card-content>
              <div class="card-meta">
                <div class="author">
                  <img
                    [src]="
                      blog.authorAvatar || 'assets/images/default-avatar.svg'
                    "
                    [alt]="blog.author"
              ...
              <div class="card-actions">
                ...
                >
                  <mat-icon>{{
                    blog.isFavorite ? 'bookmark' : 'bookmark_border'
                  }}</mat-icon>
                </button>
              </div>
            </mat-card-content>
          ...
          <div
            *ngIf="activeTabIndex === 1 && favoriteBlogs.length === 0"
            class="empty-state"
          >
  ...
  toggleBookmark(blog: Blog, event: Event): void {
    ...
    this.blogService.updateBlog(updatedBlog).subscribe({
      next: (updated) => {
        ...
        this.snackBar.open(`Article ${action} favoris`, 'Fermer', {
          duration: 2000,
        });
      },
      error: (error: Error) => {
  ...
  toggleLike(blog: Blog, event: Event): void {
    ...
    this.blogService.toggleLike(blog.id).subscribe({
      ...
      error: (error: Error) => {
        ...
        this.snackBar.open('Erreur lors de la mise à jour du like', 'Fermer', {
          duration: 3000,
        });
      },
    });
