      ...
      <div class="ad-grid">
        <mat-card
          *ngFor="let ad of advertisements"
          class="ad-card fade-in"
          (click)="navigateToAd(ad)"
        >
          <mat-card-header>
            <mat-icon
              mat-card-avatar
              [fontIcon]="getTypeIcon(ad.type)"
            ></mat-icon>
          ...
          <mat-card-content>
            <p>{{ ad.description }}</p>
            <mat-chip-list>
              <mat-chip *ngFor="let tag of ad.targetAudience">{{
                tag
              }}</mat-chip>
            </mat-chip-list>
            <div class="ad-stats"></div>
          </mat-card-content>
...
export class AdvertisementListComponent implements OnInit {
  ...
  selectedType: AdvertisementType = 'banner';
  ...
  editAdvertisement(ad: Advertisement) {
    ...
    // dialogRef.afterClosed().subscribe((result) => {
    //   if (result) {
    //     this.adService.updateAdvertisement(result).subscribe({
    //       next: () => {
    //         this.loadAdvertisements();
    //       },
    //       error: (error) => {
